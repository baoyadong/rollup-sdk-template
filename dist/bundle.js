...
(function (factory) {
  ...
  var css_248z = ".index_clockCon__3hQ7V {\n  border: 1px solid #ccc; }\n  .index_clockCon__3hQ7V .index_time__2t77- {\n    color: red;\n    font-size: 20px; }\n";
  var styles = {"clockCon":"index_clockCon__3hQ7V","time":"index_time__2t77-"};
  styleInject(css_248z);

  class Clock extends d {
      constructor() {
          super();
          this.state = {
              time: Date.now()
  ...
  var css_248z$1 = ".index_formCon__1DSoS {\n  margin-top: 10px;\n  border: 1px solid #ccc;\n  background-color: #fff; }\n";
  var styles$1 = {"formCon":"index_formCon__1DSoS"};
  styleInject(css_248z$1);

  class TodoForm extends d {
      constructor() {
          super(...arguments);
          this.state = { value: '' };
          this.onSubmit = e => {
      ...
      render() {
          ...
          return (h("form", { onSubmit: this.onSubmit, className: styles$1.formCon },
              h("input", { type: "text", value: value, onInput: this.onInput }),
              h("p", null,
  ...
  class App extends d {
      render() {
          return (h("div", null,
              ...
              h(HelloWorld, { name: '44@qq.com' })));
      }
  }
  let fragment = document.createElement('div');
  document.body.appendChild(fragment);
  O(h(App, null), fragment);
